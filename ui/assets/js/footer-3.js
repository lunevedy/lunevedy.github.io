...
function doH3Light() {
    if (document.getElementById("cb_h3_bold").checked) {
        iframe.contentWindow.document.querySelector(".footer-cols-3").classList.remove("footer-h3-weight-400");
    }
    else {
        iframe.contentWindow.document.querySelector(".footer-cols-3").classList.add("footer-h3-weight-400");
    }
}
...
function doH3UpperCase() {
    if (!document.getElementById("cb_h3_uppercase").checked) {
        iframe.contentWindow.document.querySelector(".footer-cols-3").classList.remove("footer-h3-uppercase");
    }
    else {
        iframe.contentWindow.document.querySelector(".footer-cols-3").classList.add("footer-h3-uppercase");
    }
}
...
function doIcons() {
    if (!document.getElementById("cb_icons").checked) {
        ...
        iframe.contentWindow.document.querySelector('footer .col-3:nth-child(1) p').insertAdjacentHTML("afterend", newUL.outerHTML)
    }
}
