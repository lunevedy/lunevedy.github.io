document.querySelector("#picker-box").addEventListener('click', handleLabelClick);
    ...
    function handleLabelClick(event) {
        ...
        /* h2 main heading */
            ...
            newStyle = "footer"+footerTheme+ " .col-3 h2 { color: var("+color_code+") }\n";
            sub_string = "footer"+footerTheme+" .col-3 h2 { color:"
        }

        /* organization text color */
        else if (btn_id === "btn_text_color") {
            newStyle = "footer"+footerTheme+ " .col-3 p { color: var("+color_code+") }\n";
            sub_string = "footer"+footerTheme+" .col-3 p { color:"
        }

        /* organization address color */
        else if (btn_id === "btn_address_color") {
            newStyle = "footer"+footerTheme+ " .col-3 ul li address { color: var("+color_code+") }\n";
            sub_string = "footer"+footerTheme+" .col-3 ul li address { color:"
        }

        /* h3 sub heading */
        else if (btn_id === "btn_h3_color") {
            newStyle = "footer"+footerTheme+ " .col-3 h3 { color: var("+color_code+") }\n";
            sub_string = "footer"+footerTheme+ " .col-4 h3 {";
        }
