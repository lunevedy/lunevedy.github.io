...
function doPhotosShadows() {
    ...
    // show shadow options
    document.getElementById("box-photos-shadows").style.display = "flex";
    ...
    if (!document.getElementById("cb_photos_shadows").checked) {
        for (let i = 0; i < objFigs.length; i++) {
            ...
            document.getElementById("box-photos-shadows").style.display = "none";
            document.getElementById("photos_shadows_type-1").checked=true;
            document.getElementById("photos_shadows_type-2").checked=false;
        }
    }

    // yes to photo shadows
    else {
        for (let i = 0; i < objFigs.length; i++) {
            el_figs = objFigs[i];
...
/* photos: shadow type */
document.querySelector("#form_photos_shadows_type").addEventListener("click", doPhotosShadowsType);

function doPhotosShadowsType() {
